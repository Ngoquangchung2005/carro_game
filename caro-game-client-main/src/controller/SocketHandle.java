...
//Phương thức lấy một mảng mess chưa thông tin của người dùng và chuyển đổi nó thành danh sách các đối tượng User.
...
//Phương thức này nhận một mảng message chứa thông tin xếp hạng của người dùng và chuyển đổi nó thành danh sách các đối tượng User với các thuộc tính liên quan đến xếp hạng.
...
//Phương thức này tạo một đối tượng User từ một mảng message bắt đầu từ vị trí start.
    ...
    @Override
    //phương thức xử lí kết nối
    public void run() {

        try {
            socketOfClient = new Socket("192.168.0.13", 6059);
