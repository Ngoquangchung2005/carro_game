...
public class Admin extends javax.swing.JFrame implements Runnable {
     ...
     */
    @SuppressWarnings("unchecked")// tắt các cảnh báo về việc sử dụng kiểu dữ liệu không được kiểm tra (unchecked operations).
 ...
 // Xử lý hiển thị danh sách luồng server
...
// Xử lý hiển thị danh sách phòng server
